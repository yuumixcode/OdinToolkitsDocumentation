...
``` csharp
public class MethodAnalysisDataComparer : System.Collections.Generic.Comparer<MethodAnalysisData>, System.Collections.Generic.IComparer<MethodAnalysisData>, System.Collections.IComparer
```
...
| 构造方法签名 [仅包含公共实例方法] | 注释 |
| :--- | :--- |
| `public MethodAnalysisDataComparer()` | 无 |
