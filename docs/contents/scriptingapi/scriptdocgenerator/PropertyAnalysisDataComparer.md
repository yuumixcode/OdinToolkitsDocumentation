...
``` csharp
public class PropertyAnalysisDataComparer : System.Collections.Generic.Comparer<PropertyAnalysisData>, System.Collections.Generic.IComparer<PropertyAnalysisData>, System.Collections.IComparer
```
...
| 构造方法签名 [仅包含公共实例方法] | 注释 |
| :--- | :--- |
| `public PropertyAnalysisDataComparer()` | 无 |
