...
``` csharp
public class MemberAnalysisDataComparer : System.Collections.Generic.Comparer<MemberAnalysisData>, System.Collections.Generic.IComparer<MemberAnalysisData>, System.Collections.IComparer
```
...
| 构造方法签名 [仅包含公共实例方法] | 注释 |
| :--- | :--- |
| `public MemberAnalysisDataComparer()` | 无 |
